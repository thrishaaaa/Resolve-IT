...
public void initializeClient() {
    try {
        // Load the credentials explicitly from your resources folder
        com.google.auth.oauth2.GoogleCredentials credentials = 
            com.google.auth.oauth2.GoogleCredentials.fromStream(
                new org.springframework.core.io.ClassPathResource("gcp/mediation-478113-cb54b5d286ee.json").getInputStream()
            );

        com.google.cloud.translate.v3.TranslationServiceSettings settings = 
            com.google.cloud.translate.v3.TranslationServiceSettings.newBuilder()
                .setCredentialsProvider(com.google.api.gax.core.FixedCredentialsProvider.create(credentials))
                .build();

        this.client = com.google.cloud.translate.v3.TranslationServiceClient.create(settings);
